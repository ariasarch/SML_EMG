...
# -*- coding: utf-8 -*-
"""
Created on Sat May  6 22:02:10 2023
...
def svm_model(best_params):
    model = SVC(C=best_params['C'], kernel='linear', gamma=best_params['gamma'], probability=True)
...
# Run Main Function
def exec_svm_linear(X_train, X_test, y_train, y_test):
    ...
    def evaluate_model(C, gamma):
        ...
        # Run SVM model
        model = SVC(C=C, kernel='linear', gamma=gamma, probability=True)
