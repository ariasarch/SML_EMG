...
# -*- coding: utf-8 -*-
"""
Created on Sun May  7 10:49:00 2023
...
def svm_model(best_params):
    model = SVC(C=best_params['C'], kernel='poly', degree=3, gamma=best_params['gamma'], probability=True)
...
# Run Main Function
def exec_svm_cubic(X_train, X_test, y_train, y_test):
    ...
    def evaluate_model(C, gamma):
        ...
        # Run SVM model
        model = SVC(C=C, kernel='poly', degree=3, gamma=gamma, probability=True)
