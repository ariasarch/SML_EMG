...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun  1 10:02:57 2023
...
average_df = se.calculate_averages(model_search_df, base_path, filename='Single_Model_Average.csv', non_average_columns=['Model Name', 'Time'])
